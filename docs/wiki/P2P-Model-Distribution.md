# Peer-to-Peer Model Weight Distribution & Zero-Downtime Hot-Reloading
...
1. **Chunking (`ModelChunker`):** Weights are sliced into deterministic $512\text{ KB}$ or $1\text{ MB}$ chunks (`ModelChunk`).
